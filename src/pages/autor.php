...
<body>
    <nav>
        <ul class="nav">
            ...
            <li id="barra-buscar">
                <form action="" method="get" class="buscar-container"> <!--ruta de php en action= ../php/barrabuscar.php-->
            ...
            <li>
                <a id="carrito" href="carrito.html"><img src="../assets/images/carro.png" alt="carrito" height="35px"></a>
            </li>
        </ul>
    ...
    <footer>
        ...
        <div class="links">
            ...
            <a href="mailto:mari.d3v@gmail.com" target="_blank" rel="noreferrer" title="Email : mari.d3v@gmail.com">
    ...
    <script src="../scripts/carrusel-recomendaciones.js"></script>
</body>
</html>